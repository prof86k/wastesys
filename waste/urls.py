...
urlpatterns = [  
    ...
    path('waste-type',vi.waste_type_collected,name='waste_types'),
    path('edit-waste/type/<int:waste_type>',vi.edit_waste_type_collected,name='edit_type'), 
    ...
    path('wastes-disposed',vi.waste_disposal,name='waste_disposed'), 
